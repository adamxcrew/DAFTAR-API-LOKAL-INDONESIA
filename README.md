...
| KBBI Complete REST API           | [raf555](http://github.com/raf555)           | [Link](https://kbbi.raf555.dev/swagger/index.html)                                   | ✅     | Alternatif API KBBI - hasil mirror aplikasi Android (tanpa web scraping). Informasi dan dokumentasi lengkap, low latency, serta fitur bawaan aplikasi seperti "Kata hari ini".                  | `false`     |
